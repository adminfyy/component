import React, { useContext, useCallback, useRef, useState, useMemo } from "react";
...
const Sticky: React.FC<IStickyProps> = (props) => {
    ...
    const handleContainerEvent = useCallback(({
        ...
        if (relative) {
            ...
            distanceFromTop = -(eventSource.scrollTop + eventSource.offsetTop) + placeholder.current?.offsetTop;
        }
    ...
    const style = useMemo(() => state.isSticky ? {
