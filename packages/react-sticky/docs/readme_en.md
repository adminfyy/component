...
subscribe the events of the nearest container might trigger sticky
...
sticky 钩子函数，用于监听最近的一个 StickContainer 的事件，回调函数参数有

- eventSource 事件触发来源 DOM，通常是 container 或者 body
